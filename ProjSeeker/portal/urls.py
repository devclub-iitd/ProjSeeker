...
urlpatterns = [
    ...
    url(r'^my-projects$', ProjectViewSet.as_view({'get': 'my_projects'}),  name='my-projects'),
    url(r'^applied-projects$', ProjectViewSet.as_view({'get': 'applied_projects'}),  name='applied-projects'),
    url(r'^new-project$', ProjectViewSet.as_view({'get': 'create_new_project'}), name='new-project'),
    url(r'^received-applications$', ApplicationViewSet.as_view({'get': 'list_received_applications'}), name='list-received-applications'),
    url(r'^view-applications$', ApplicationViewSet.as_view({'get': 'view_received_applications'}), name='view-received-applications'),
]
